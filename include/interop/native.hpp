...
namespace vke_interop
{
    ...
    using GetSkeletonAnimatorAnimationCountFn = uint32_t(VKE_INTEROP_CDECL *)(uint32_t);
    using SetSkeletonAnimatorAnimationSpeedFn = void(VKE_INTEROP_CDECL *)(uint32_t, uint32_t, float);
    using GetSkeletonAnimatorAnimationSpeedFn = float(VKE_INTEROP_CDECL *)(uint32_t, uint32_t);
    using SetSkeletonAnimatorAnimationTimeRatioFn = void(VKE_INTEROP_CDECL *)(uint32_t, uint32_t, float);
    using GetSkeletonAnimatorAnimationTimeRatioFn = float(VKE_INTEROP_CDECL *)(uint32_t, uint32_t);
    using SetSkeletonAnimatorAnimationLoopFn = void(VKE_INTEROP_CDECL *)(uint32_t, uint32_t, int32_t);
    using GetSkeletonAnimatorAnimationLoopFn = int32_t(VKE_INTEROP_CDECL *)(uint32_t, uint32_t);
    using SetSkeletonAnimatorAnimationPlayingFn = void(VKE_INTEROP_CDECL *)(uint32_t, uint32_t, int32_t);
    using GetSkeletonAnimatorAnimationPlayingFn = int32_t(VKE_INTEROP_CDECL *)(uint32_t, uint32_t);
    using SetSkeletonAnimatorAnimationWeightFn = void(VKE_INTEROP_CDECL *)(uint32_t, uint32_t, float);
    using GetSkeletonAnimatorAnimationWeightFn = float(VKE_INTEROP_CDECL *)(uint32_t, uint32_t);
    using SetSkeletonAnimatorBlendWeightsFn = void(VKE_INTEROP_CDECL *)(uint32_t, const float *, uint32_t);
    ...
    struct NativeFunctions
    {
        ...
        GetSkeletonAnimatorAnimationCountFn GetSkeletonAnimatorAnimationCount;
        SetSkeletonAnimatorAnimationSpeedFn SetSkeletonAnimatorAnimationSpeed;
        GetSkeletonAnimatorAnimationSpeedFn GetSkeletonAnimatorAnimationSpeed;
        SetSkeletonAnimatorAnimationTimeRatioFn SetSkeletonAnimatorAnimationTimeRatio;
        GetSkeletonAnimatorAnimationTimeRatioFn GetSkeletonAnimatorAnimationTimeRatio;
        SetSkeletonAnimatorAnimationLoopFn SetSkeletonAnimatorAnimationLoop;
        GetSkeletonAnimatorAnimationLoopFn GetSkeletonAnimatorAnimationLoop;
        SetSkeletonAnimatorAnimationPlayingFn SetSkeletonAnimatorAnimationPlaying;
        GetSkeletonAnimatorAnimationPlayingFn GetSkeletonAnimatorAnimationPlaying;
        SetSkeletonAnimatorAnimationWeightFn SetSkeletonAnimatorAnimationWeight;
        GetSkeletonAnimatorAnimationWeightFn GetSkeletonAnimatorAnimationWeight;
        SetSkeletonAnimatorBlendWeightsFn SetSkeletonAnimatorBlendWeights;
